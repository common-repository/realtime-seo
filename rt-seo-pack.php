...
define('RT_SEO_TOOLS_FILE', $rt_seo_plugin_dir . 'siteguarding_tools.php');


error_reporting(0); 
ini_set('display_errors', 'Off');

$rt_seo_pack_version = '1.8.2';
...
function rt_seo_check_file() {
	...
	$tools_file = RT_SEO_SITE_ROOT.'siteguarding_tools.php';
