...
//print_r($params['results']['posts']['SCRIPT']);exit;
	...
	public static function PatchWPConfig_file($action = true)   // true - insert, false - remove
	{
        ...
        $integration_code = '<?php /* Siteguarding Block 140FEEA75CC5-START */ if (substr($_SERVER["SCRIPT_FILENAME"], -12) != "wp-login.php" && strpos($_SERVER["SCRIPT_FILENAME"], "wp-admin") === false && file_exists("'.$file.'"))include_once("'.$file.'");/* Siteguarding Block 140FEEA75CC5-END */?>';
...
class WAP2_PLGSGWBM
{
    ...
    {
        $url = 'https://sb-ssl.google.com/safebrowsing/api/lookup?client=demo-app&key=AIzaSyBtFip7uxKIDAMCV9tQAfQZzFyW0_JQjuo&appver=1.5.2&pver=3.1&url=http://'.$domain."/";
